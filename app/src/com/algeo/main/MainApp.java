...
//
//        FileHandler getMatrix = new FileHandler("test.txt");
//        getMatrix.readFile();
...
//
//                                    menu_readMatrix(matrix);
//
////                                    FileHandler inputMethod = new FileHandler( filename + ".txt");
//                                    Det = new BDMatrix(matrix);
//                                    Det.printMatrix();
...
//                                    }
    ...
    private static void main_menu() {
        ...
        System.out.println("6. Baca Matrix dari File");
    ...
    private static void menu_readMatrix(BDMatrix matrix)
    {
        ...
        FileHandler getMatrix = new FileHandler(readFileName.nextLine() + ".txt");
        getMatrix.readFile();
        matrix = getMatrix.getData();
        matrix.printMatrix();
    }
